...
## Summary
The Neighborhood Map Project (NMP) is an app to help you identify local art galleries and museums using the Google Maps API and Wikipedia API to display 5 popular museums in downtown Seattle area.
...
To run the application: through Github
